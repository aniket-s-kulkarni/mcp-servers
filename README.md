...
- <img height="12" width="12" src="https://www.dremio.com/wp-content/uploads/2022/04/favicon.png" alt="Dremio Logo" /> **[Dremio](https://github.com/dremio/dremio-mcp)** - AI-native data discovery and query capabilities for the intelligent lakehouse platform, enabling AI agents to dynamically explore datasets, generate queries, and retrieve governed data in real time. [Learn more](https://www.dremio.com/press-releases/dremio-launches-new-mcp-server-furthers-its-leadership-in-accelerating-agentic-applications/)
